...
public class GameController {
  ...
  private void btnMusic(ActionEvent event) {
    if(!musicON) {
      Image img = new Image(getClass().getResourceAsStream("/diezmil/images/unmute.png"));
      musicIcon.setImage(img);
      reproductor.play();
      musicON = true;
    }else {
      Image img = new Image(getClass().getResourceAsStream("/diezmil/images/mute.png"));
      musicIcon.setImage(img);
      reproductor.pause();
      musicON = false;
    }
  ...
  private void rollDiceClick(ActionEvent event) {
    ...
    for (int i = 0; i < game.getDiceCup().getDice().size(); i++) {
      diceImage[i]
          .setImage(new Image(getClass().getResourceAsStream("/diezmil/images/die_roll_animation.gif")));
  ...
  private void setImageDiceDefault() {
    for (int i = 0; i < diceImage.length; i++) {
      diceImage[i].setImage(new Image(getClass().getResourceAsStream("/diezmil/images/die_selected.png")));
    }
  }
  ...
  private void updateDiceImage(int i) {
    ...
    diceImage[i]
        .setImage(new Image(getClass().getResourceAsStream("/diezmil/images/die" + value + ".png")));
